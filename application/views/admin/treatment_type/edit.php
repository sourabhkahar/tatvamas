                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="amount" name="amount" value="<?= $details->amount; ?>" placeholder="Enter Amount" min="0" step="0.01" required>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-12">
                                        <div class="form-group">
    ...
    $(document).ready(function () {
        jQuery("#form_validation").on('submit', function (e) {
            ...
            if (form.parsley().isValid()) {
                sendFormRequest(/*Request path*/site_url + "treatment_type/edit/<?= $details->treatment_type_id; ?>",
