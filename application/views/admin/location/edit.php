                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="<?= $details->name; ?>" placeholder="Enter Name" maxlength="255" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="code">Code</label>
                                            <input type="text" class="form-control" id="code" name="code" value="<?= $details->code; ?>" placeholder="Enter Amount" maxlength="255" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Description</label>
                                            <textarea id="description" class="form-control" name="description" placeholder="Enter Message Here....." rows="5"><?= $details->description; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
    ...
    $(document).ready(function () {
        jQuery("#form_validation").on('submit', function (e) {
            ...
            if (form.parsley().isValid()) {
                sendFormRequest(/*Request path*/site_url + "locations/edit/<?= $details->locations_id; ?>",
