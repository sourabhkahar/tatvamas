                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" name="mobile_no" class="form-control" id="mobile_no" value=""
                                            placeholder="Enter Mobile No" autocomplete="off" data-parsley-trigger="keyup" data-parsley-validation-threshold="1" data-parsley-debounce="500" data-parsley-type="digits" 
